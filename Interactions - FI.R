...
##Linear regression of AD PRS on FI in full sample
model_all <- lm(Fluid_intelligence ~ AD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                  PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
summary(model_all)

##Linear regression in high EA PRS sample (top 50%)
model_top50_EA_PRS <- lm(Fluid_intelligence ~ AD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
...
model_bottom50_EA_PRS <- lm(Fluid_intelligence ~ AD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
...
##Interaction test
model_interaction <- lm(Fluid_intelligence ~ AD_PRS_standarized * EA_PRS_half + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                            PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
...
##High education
model_high_edu <- lm(Fluid_intelligence ~ AD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                       PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = subset(data, edu_binary == 1))
summary(model_high_edu)

##Low education
model_low_edu <- lm(Fluid_intelligence ~ AD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
...
##Interaction test
model_interaction_2 <- lm(Fluid_intelligence ~ AD_PRS_standarized * edu_binary + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                            PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
...
##Linear regression of VAD PRS on FI in full sample
model_all <- lm(Fluid_intelligence ~ VAD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                  PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
summary(model_all)

##Linear regression in high EA PRS sample (top 50%)
model_top50_EA_PRS <- lm(Fluid_intelligence ~ VAD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                           PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data_top_EA_half)
summary(model_top50_EA_PRS)

##Linear regression in low EA PRS sample (bottom 50%)
model_bottom50_EA_PRS <- lm(Fluid_intelligence ~ VAD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                              PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data_bottom_EA_half)
summary(model_bottom50_EA_PRS)
...
##Interaction test
model_interaction <- lm(Fluid_intelligence ~ VAD_PRS_standarized * EA_PRS_half + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                          PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
summary(model_interaction)
...
##High education
model_high_edu <- lm(Fluid_intelligence ~ VAD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                       PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = subset(data, edu_binary == 1))
summary(model_high_edu)

##Low education
model_low_edu <- lm(Fluid_intelligence ~ VAD_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                      PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = subset(data, edu_binary == 0))
summary(model_low_edu)
...
##Interaction test
model_interaction_2 <- lm(Fluid_intelligence ~ VAD_PRS_standarized * edu_binary + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                            PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
summary(model_interaction_2)

...
model_all <- lm(Fluid_intelligence ~ EA_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                  PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
summary(model_all)

##Linear regression in high AD PRS sample (top 50%)
model_top50_AD_PRS <- lm(Fluid_intelligence ~ EA_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
...
model_bottom50_AD_PRS <- lm(Fluid_intelligence ~ EA_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
...
##Interaction test
model_interaction <- lm(Fluid_intelligence ~ AD_PRS_standarized * EA_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                          PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
...
##Linear regression in whole sample
model_all <- lm(Fluid_intelligence ~ Years_of_schooling + Sex + Age + Assessment_centre, data = data)
summary(model_all)

##Linear regression in high AD PRS sample (top 50%)
model_top50_AD_PRS <- lm(Fluid_intelligence ~ Years_of_schooling + Sex + Age + Assessment_centre, data = data_top_AD_half)
summary(model_top50_AD_PRS)

##Linear regression in low AD PRS sample (bottom 50%)
model_bottom50_AD_PRS <- lm(Fluid_intelligence ~ Years_of_schooling + Sex + Age + Assessment_centre, data = data_bottom_AD_half)
summary(model_bottom50_AD_PRS)
...
##Interaction test
model_interaction_2 <- lm(Fluid_intelligence ~ AD_PRS_standarized * Years_of_schooling + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                            PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
...
model_top50_VAD_PRS <- lm(Fluid_intelligence ~ EA_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
...
model_bottom50_VAD_PRS <- lm(Fluid_intelligence ~ EA_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
...
##Interaction test
model_interaction <- lm(Fluid_intelligence ~ VAD_PRS_standarized * EA_PRS_standarized + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                          PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
summary(model_interaction)
...
##Linear regression in high VAD PRS sample (top 50%)
model_top50_VAD_PRS <- lm(Fluid_intelligence ~ Years_of_schooling + Sex + Age + Assessment_centre, data = data_top_VAD_half)
summary(model_top50_VAD_PRS)

##Linear regression in low VAD PRS sample (bottom 50%)
model_bottom50_VAD_PRS <- lm(Fluid_intelligence ~ Years_of_schooling + Sex + Age + Assessment_centre, data = data_bottom_VAD_half)
summary(model_bottom50_VAD_PRS)
...
##Interaction test
model_interaction_2 <- lm(Fluid_intelligence ~ VAD_PRS_standarized * Years_of_schooling + Sex + Age + Assessment_centre + Genotype_batch + PCA_1 + PCA_2 + PCA_3 + PCA_4 + PCA_5 +
                            PCA_6 + PCA_7 + PCA_8 + PCA_9 + PCA_10, data = data)
summary(model_interaction_2)
